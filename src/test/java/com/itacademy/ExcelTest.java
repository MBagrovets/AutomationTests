...
public class ExcelTest {
    ...
    public Object[][] excelDataProvider() throws IOException {          //создание дата провайдера
        Object[][] arrObj = getExcelData("src/test/resources/excel/ExcelTestFile.xlsx","Лист1");
        return arrObj;
    }
